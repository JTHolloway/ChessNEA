...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        new JBoardGUI(GameType.LOCAL_MULTIPLAYER,  Colour.WHITE, me);
...
////        moves = g.getBoard().ReturnSquare(new Coordinate(5,3)).ReturnPiece().CalculateValidMoves(g.getBoard());
